...
const initialValues = {
    soilType: '', district: '', subDistrict: '', blockName: '', villageName: '',
    ...
    return(
        <div>
            ...
            <Grid container rowSpacing={2}>
                ...
                <Grid container rowSpacing={2}>
                    <Grid item md={5}><TextField style={{width: "30em"}} error={touched.state && errors.state} id="outlined-basic" label="Soil Type" variant="outlined" name='soilType' value={values.state} onChange={handleChange} onBlur={handleBlur} helperText={touched.state && errors.state}/> </Grid>

                    <Grid item md={5}><TextField style={{width: "30em"}} error={touched.district && errors.district}  id="outlined-basic" label="Date of Test Result Entry" variant="outlined" name='district' value={values.district} onChange={handleChange} onBlur={handleBlur} helperText={touched.district && errors.district}/> </Grid>
